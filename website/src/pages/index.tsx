    ...
    return (
        <Layout>
            ...
            <IntroBox>
                ...
                <Paragraph>
                    <VinceStyle>I help people</VinceStyle> and organizations to
                    build digital products that can continue to adapt quickly as
                    they grow. By using the right tools and techniques fitting
                    the context of teams and the problems they're solving, I'm
                    obsessed with bringing joy and excitement to people working
                    together to bring something useful into the world!
                </Paragraph>
                <Paragraph>
                    What does that look like? Over the last years, I've helped
                    WorldBrain to build{" "}
                    <ExternalLink href="https://memex.garden/">
                        Memex
                    </ExternalLink>
                    , setting up in such a way that with a 2-developer team we
                    were able to
                    <ol>
                        <li>
