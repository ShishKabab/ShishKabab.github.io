...
Over the last years as CTO of WorldBrain I've helped to build to build <ExternalLink href="https://memex.garden/">Memex</ExternalLink>, setting up in such a way that with a 2-developer team we were able to
