...
I’d love to make this technology open source. Seeing the projected economical impact however, I’d like to get a fair compensation based on this. Therefore, I’m currently looking for grants that allow me to open source the code generation tool and launch it as a proper open source project with awesome documentation for developers, designers and product owners.
