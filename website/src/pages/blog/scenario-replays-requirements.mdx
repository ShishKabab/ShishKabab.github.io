...
import MailingListLink from "../../components/mailing-list-link"
...
I’ll dive into the most interesting aspects of some of these complexities one by one as part of the _scenario replays and cross-team collaboration_ series. If you want to receive articles as they come out, you can <MailingListLink>subscribe to the series by joining the mailing list</MailingListLink>.

<!-- Also, I’m creating a boilerplate that shows how to integrate all of these concepts and more in a real code setup. I’m still figuring out what it’s price should be, but I’m thinking of €500. Interested? Join the waiting list and send me your feedback and ideas! -->
