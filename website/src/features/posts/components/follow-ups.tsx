...
export default function FollowUpPosts(props: {
  ...
  if (isSemiLastPost) {
    ...
    return (
      <div>
        Since publishing this article, I've published this follow-up article:{" "}
        <a href={lastPost.href}>{lastPost.label}</a>
      </div>
    );
  }
  ...
  return (
    <div>
      Since publishing this article, I've published these follow-up articles:
      <ul>
